...
#funcion para selecionar el algoritmo de planificación de procesos
...
btMemoria = ttk.Button(framebotones, text="Memoria", command = lambda: mostrar_memoria()).grid(column=4, row=1, padx=10 )
btSelecionar = ttk.Button(framebotones, text="Selecionar", command = lambda: mostrar_select()).grid(column=5, row=1, padx=10)
